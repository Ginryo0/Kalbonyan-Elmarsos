  ...
  req.user
    ...
    .then((user) => {
      ...
      return stripe.checkout.sessions.create({
        ...
        mode: 'payment',
        success_url:
          req.protocol + '://' + req.get('host') + '/checkout/success', // http + :// + localhost:3000 + /checkout/sucess
...
exports.getInvoice = (req, res, next) => {
  ...
  Order.findById(orderId)
    .then((order) => {
      ...
      // generate a new PDF - Write (stream) it into filestorage - stream it into resposne
